                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="addsupplier.php" data-toggle="validator" method="post">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Supplier *</label>
                                                <input type="text" class="form-control" placeholder="Enter Supplier" name="supplier" id="supplier"
                                                    required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter PAN Number" name="pan" id="pan"
                                                    required>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
